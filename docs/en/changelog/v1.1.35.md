...
1. Open settings, find "Server" option
2. Click "Manage Servers" to enter the management interface
3. Add, delete, or edit your server configurations
...
2. Select Kimi K2.5 model
3. Adjust recommended topP and temperature settings
